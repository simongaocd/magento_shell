...
yum install -y mysql-shell-8.0.22 
mkdir ~opc/.mysqlsh
...
then    
  ...
  dnf -y install php php-cli php-mysqlnd php-zip php-gd php-mcrypt php-mbstring php-xml php-json php-opcache php-bcmath php-soap php-pear-Net-Socket php-intl
else
